...
INDEX=$TCRUZI_CL_GENOME_BASE_PATH/index/bowtie/TriTrypDB-46_TcruziCLBrenerEsmeraldo-like_Genome_index

#Output folder
OUT_BASE_PATH=/home/pbeati/proyecto_mnaseq_Tcruzi_2019/alineamientos/2020/bowtie/
...
do
	...
	out_file_name=$OUT_BASE_PATH$exp_name.sam
