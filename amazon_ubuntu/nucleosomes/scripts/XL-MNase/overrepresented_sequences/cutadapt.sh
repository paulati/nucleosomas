...
LOCAL_READS_BASE_PATH=/home/ubuntu/tmp_disk/reads/XL-MNase
S3_READS_BASE_PATH=s3://tcruzi-nucleosome/XL-MNase/reads
LOCAL_CLEAN_READS_BASE_PATH=$LOCAL_READS_BASE_PATH/clean  
S3_CLEAN_READS_BASE_PATH=$S3_READS_BASE_PATH/replicate1_clean
...
for file_head in $files_head; do
	...
	RAW_S3_READS_BASE_PATH=$S3_READS_BASE_PATH/replicate1
