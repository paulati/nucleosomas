...
S3_READS_R1_FILE_NAME=Me2_IP_350U_S6_R1_001.fastq.gz
S3_READS_R2_FILE_NAME=Me2_IP_350U_S6_R2_001.fastq.gz
...
LOCAL_READS_BASE_PATH=$LOCAL_DATA_BASE_PATH/reads/XL-MNase/clean
...
S3_READS_BASE_PATH=$S3_DATA_BASE_PATH/XL-MNase/reads/replicate1_clean
